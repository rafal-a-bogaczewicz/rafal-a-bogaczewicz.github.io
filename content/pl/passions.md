...
<p style="text-align: left; font-size: 1.1em; margin-bottom: 20px; color: var(--text-color);">
    Odkrywanie świata to nie tylko fizyka — poniższe zainteresowania to inne ścieżki zgłębiania rzeczywistości i&nbsp;zachwytu nad&nbsp;jej pięknem.
</p>
...
<div class="travel-grid">
    <div class="passion-item">
        ...
        <p class="img-caption">
            Zwiedzanie San Sebastián po&nbsp;<a href="https://nanoqi-2024.dipc.org" class="pub-link" target="_blank" rel="noopener">konferencji</a>.
        </p>
    </div>
    <div class="passion-item">
...
<!-- Sekcja dwukolumnowa: ROWER | GÓRY - podciągnięta pionowo -->
...
<!-- Kreska i cytat Einsteina - podciągnięte -->
